...
import { useViewportSize } from "@agotao/utils";
...
export const Popover: React.FC<PopoverProps> = ({
  ...
  async function handleDragEnd(
    ...
    const height = (mobileTooltipRef.current as any).getBoundingClientRect()
      .height;
  ...
  useEffect(() => {
    setOpenPopover(false);
  }, [router.query.slug]); // eslint-disable-line react-hooks/exhaustive-deps
